...
async def main_loop(detector: UtteranceDetector, stt: WhisperSTT, convo: Conversation, speaker: BaseSpeaker, voice_identifier: _VoiceIdentifier, people: List[Person]):
